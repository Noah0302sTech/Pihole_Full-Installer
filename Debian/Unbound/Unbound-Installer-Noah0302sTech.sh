...
#	wget https://raw.githubusercontent.com/Noah0302sTech/Pihole_Full-Installer/master/Debian/Unbound/Unbound-Installer-Noah0302sTech.sh && sudo bash Unbound-Installer-Noah0302sTech.sh
